...
class OrganizationController(
    ...
    fun getHrPartners(@RequestHeader(EStellaHeaders.jwtToken) jwt: String?): ResponseEntity<MutableList<HrPartnerPayloads.HrPartnerResponse>> {
        ...
        return hrPartnerService.getHrPartners()
            ...
            .map { HrPartnerPayloads.HrPartnerResponse.fromHrPartner(it) }
